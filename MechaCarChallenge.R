...
library(tidyverse)
mecha_mpg <- read.csv(file='Users/Elena Rivera/Desktop/Repositories/MechaCar_Statistical_Analysis/MechaCar_mpg.csv',check.names=F,stringsAsFactors = F) 
...
mecha_coil <- read.csv(file='C:/Users/Elena Rivera/Desktop/Repositories/MechaCar_Statistical_Analysis/Suspension_Coil.csv',check.names=F,stringsAsFactors = F) 
